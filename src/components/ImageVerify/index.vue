<template>
  <div class="image-verify">
    ...
    >
      ...
      <div class="content">
        <div @mousedown="areaMousedown" @mousemove="areaMousemove" @click="areaClick">
          <div class="entire-image" :style="style1" />
          <div @mousedown.stop :style="style3" class="valid-area" />
...
export default {
  ...
  methods: {
    ...
    func () {
      if (this.clickFalg) this.areaClick()
    },
    ...
    areaMousemove (e) {
      if (this.clickFalg) {
        let blockX = e.target.offsetLeft + (e.offsetX - this.tempX)
        let blockY = e.target.offsetTop + (e.offsetY - this.tempY)
